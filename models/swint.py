...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.rmhca = nn.ModuleList()
        self.rmhca.append(RMHCA(384))
        self.rmhca.append(RMHCA(768))
    ...
    def init_weights(self, glip_checkpoint=None, pretrained=None):
...
def build_swint_backbone():
    """
    Create a SwinT instance from config.

    Returns:
        SwinT: a :class:`SwinTransformer` instance.
    """
